...
FCIS 與 Mask R-CNN 都有針對平移敏感性 - translation variance 作加強，

因為以 Fully Convolution 的特性，

其實是有平移不變性 - translation invariance，

以在分類的問題上來說，

平移不變性是個優勢，

但是在 Segment 的問題上來說鄰近的點可能也是同一個物件，

因此要考量到如何增加 translation variance 的動作。

那幸運的是在 Prototype 的視覺化中，
